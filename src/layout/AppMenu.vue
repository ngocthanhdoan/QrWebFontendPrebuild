...
const model = ref([
    ...
    },
    {
        label: 'Home',
        items: [
            { label: '	Thư giới thiệu sản phẩm', icon: 'pi pi-fw pi-circle-off', to: '/' },
            { label: '	Danh sách các đơn thụ lý', icon: 'pi pi-fw pi-circle-off', to: '/listMain' }
        ]
    },

    {
        label: 'Nhập hồ sơ yêu cầu bảo hiểm',
        items: [
